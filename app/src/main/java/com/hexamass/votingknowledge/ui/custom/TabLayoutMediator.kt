    ...
    private class TabLayoutOnPageChangeCallback internal constructor(tabLayout: TabLayout) :
        ...
        override fun onPageScrolled(position: Int, positionOffset: Float, positionOffsetPixels: Int) {
            ...
            if (tabLayout != null) {
                ...
                // being dragged
                val updateText = mScrollState != ViewPager2.SCROLL_STATE_SETTLING || mPreviousScrollState == ViewPager2.SCROLL_STATE_DRAGGING
                // Update the indicator if we're not settling after being idle. This is caused
                // from a setCurrentItem() call and will be handled by an animation from
                // onPageSelected() instead.
                val updateIndicator =
                    !(mScrollState == ViewPager2.SCROLL_STATE_SETTLING && mPreviousScrollState == ViewPager2.SCROLL_STATE_IDLE)
        ...
        override fun onPageSelected(position: Int) {
            ...
            if (tabLayout != null
                ...
                val updateIndicator =
                    mScrollState == ViewPager2.SCROLL_STATE_IDLE || mScrollState == ViewPager2.SCROLL_STATE_SETTLING && mPreviousScrollState == ViewPager2.SCROLL_STATE_IDLE
